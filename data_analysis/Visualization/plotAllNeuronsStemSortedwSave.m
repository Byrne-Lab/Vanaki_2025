...
function [h,sortedIndices,sortedW] = plotAllNeuronsStemSortedwSave(X,H,W,BMPintervalTimes,BMPtypes,fullPath, power, CellOrder)
...
%        of dif neurons to these patterns
  ...
  % Assuming sortedIndices and CellOrder are provided, added 8/26/2024
  newYLabels = CellOrder(sortedIndices);
